...
class Twig
{
  ...
  private $functions_asis = [
    'base_url', 'site_url', 'route', 'current_url', 'rtrim', 'addslashes', 'redirect', 'in_array', 'urlencode', 'class_exists', 'load_widget'
  ];
  ...
  {
    $this->limpid->emitter->emit('beforePageRender');
    $this->limpid->output->set_output($this->render($view, $params));
  }
